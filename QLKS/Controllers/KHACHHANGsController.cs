...
namespace QLKS.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,HoTenKH,SoDT")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["QLKSDbContext"].ConnectionString);
            ...
            bulkcopy.ColumnMappings.Add(2, "SoDT");
